...
5) Using a Linea Ridge as baseline.
...
2) because the data in LINK dataset is sequential (daily recordings) I was required to train the model with first few 
sessions so that this model does not see the future sessions during training.